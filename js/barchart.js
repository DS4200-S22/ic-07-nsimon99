...
const mouseover2 = function(event, d) { //creates function
  tooltip2.html("Name: " + d.name + "<br> Score: " + d.score + "<br>") // shows data when mouse is over
          .style("opacity", 1);  //sets opacity for when mouse is over
}
...
const mouseleave2 = function(event, d) { //creates function
  tooltip2.style("opacity", 0); //sets opacity
}
...
svg3.append("g") //appends placeholder 
    ...
    .call(d3.axisBottom(xScale3) 
            .tickFormat(i => data2[i].name))  // sets up x axis to the bottom and ticks
    .attr("font-size", '20px'); // defines font and size of y axis
...
const mouseover3 = function(event, d) { //creates function
  tooltip3.html("Name: " + d.name + "<br> Score: " + d.score + "<br>") // shows data when mouse is over
          .style("opacity", 1);  //sets opacity for when mouse is over
}
